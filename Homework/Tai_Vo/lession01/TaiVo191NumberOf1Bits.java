...
public class TaiVo191NumberOf1Bits {
    public static void main(String[] args) {
        ...
        System.out.println(new TaiVo191NumberOf1Bits().hammingWeight(11));
        System.out.println(String.format("%32s", Integer.toBinaryString(128)).replace(' ', '0'));
        System.out.println(new TaiVo191NumberOf1Bits().hammingWeight(128));
        System.out.println(String.format("%32s", Integer.toBinaryString(-3)).replace(' ', '0'));
        System.out.println(new TaiVo191NumberOf1Bits().hammingWeight(-3));
    }
